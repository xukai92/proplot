...
_rc_renamed = {  # {old_key: (new_key, version)} dictionary
    ...
    'title.bbox': ('title.box', '0.11'),
    'title.bboxcolor': ('title.boxcolor', '0.11'),
    'title.bboxalpha': ('title.boxalpha', '0.11'),
    'title.bboxstyle': ('title.boxstyle', '0.11'),
    'title.bboxpad': ('title.boxpad', '0.11'),
    'abc.bbox': ('abc.box', '0.11'),
    'abc.bboxcolor': ('abc.boxcolor', '0.11'),
    'abc.bboxalpha': ('abc.boxalpha', '0.11'),
    'abc.bboxstyle': ('abc.boxstyle', '0.11'),
    'abc.bboxpad': ('abc.boxpad', '0.11'),
}
